...
/**
 * This class provides an empty implementation of {@see assembler3Visitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class assembler3BaseVisitor extends AbstractParseTreeVisitor implements assembler3Visitor
{
	/**
	 * {@inheritdoc}
	 *
